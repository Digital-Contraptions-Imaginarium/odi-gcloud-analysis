...
d <- d[grep("open data", d$description, ignore.case = TRUE), c('supplier_name', 'sku', 'name', 'cloudstoreUrl', 'description')] %.% arrange(supplier_name, name)
# save CSV version before transformations for improved readability in Markdown
write.csv(d, 'all_open_data.csv')
