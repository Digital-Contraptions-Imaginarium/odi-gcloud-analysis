...
d <- d[grep("open data", d$description, ignore.case = TRUE), c('supplier_name', 'name', 'cloudstoreUrl', 'description')] %.% arrange(supplier_name, name)
# filter for this specific report
# d <- d[grep("analysis", d$description, ignore.case = TRUE), ] 
