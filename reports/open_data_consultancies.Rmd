...
description includes both the "data" and "consultancy" keywords.
...
d <- d[grep("consultancy", d$description, ignore.case = TRUE), c('supplier_name', 'name', 'cloudstoreUrl', 'description')] %.% arrange(supplier_name, name)
